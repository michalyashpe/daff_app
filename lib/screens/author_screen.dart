...
class _AuthorScreenState extends State<AuthorScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(body: Consumer<AuthorProvider>(
      ...
      return CustomScrollView(slivers: <Widget>[
                ...
                ? IconButton(
                    onPressed: () => Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => RedirectingScreen(
                            'http://www.daff.co.il/authors/${model.author.id}'))),
        ...
        SliverList(
          ...
          [
            ...
            _buildAuthorDetails(
                model.author, model.isLoading), //model.isLoading),
            SizedBox(
              height: 20.0,
            ),
            model.isLoading
            ...
            Row(
              children: <Widget>[
                loading
                    ...
                    : buildAvatarImage(author.imageUrl),
                SizedBox(width: 20.0),
                loading
  ...
  Widget _buildAuthorStastLoader() {
    ...
    return Row(
      children: <Widget>[stats, stats, stats],
    );
  }
        ...
        : Row(
            children: <Widget>[
              Column(
                ...
                children: <Widget>[
                  Text(author.storiesCount.toString(),
                      style: TextStyle(
              ...
              Column(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: <Widget>[
                  Text(author.cheersCount.toString(),
                      style: TextStyle(
                          fontSize: 20.0, fontWeight: FontWeight.bold)),
                  Text('פירגונים')
                ],
              ...
              Column(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: <Widget>[
                  Text(author.readsCount.toString(),
                      style: TextStyle(
                          fontSize: 20.0, fontWeight: FontWeight.bold)),
                  Text('קריאות')
                ],
  ...
  Widget _buildAuthorStories(Author author, bool loading) {
    ...
    author.stories.forEach((Story story) {
      storyPreviewList
          .add(buildStoryPreviewWidget(story, context, authorName: false));
      storyPreviewList.add(SizedBox(
        height: 5.0,
      ));
    });
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[Column(children: storyPreviewList)],
    );
  }
}
