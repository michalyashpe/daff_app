    ...
    child: Column(
      ...
      children: <Widget>[
        Expanded(
          ...
          children: <Widget>[
            DrawerHeader(
                ...
                child: buildUserDrawerAvatar(context) //buildAppLogoLarge()
                ),
            ListTile(
              dense: true,
              ...
              onTap: () {
                ...
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => StoryScreen(544)));
              },
            ),
            ListTile(
              dense: true,
              ...
              onTap: () {
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            StoriesScreen('עדכוני מערכת', 'tag=עדכון')));
              },
            ),
            ListTile(
              dense: true,
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) => StoriesScreen(
                            'בחירות העורך', 'editor_votes=true')));
              },
            ),
            ListTile(
              dense: true,
              ...
              onTap: () {
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            StoriesScreen('אתגר התלונה', 'tag=אתגר התלונה')));
              },
            ),
            ListTile(
              dense: true,
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.pop(context);
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => StoryScreen(1959)));
              },
            ),
        ...
        Container(
          ...
          children: <Widget>[
            Text(' כל הזכויות שמורות לכותבים ולכותבות ',
...
Widget buildUserDrawerAvatar(BuildContext context) {
      ...
      ? GestureDetector(
          onTap: () {
            ...
            Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) =>
                        AuthorScreen(user.author.name, user.id)));
          },
          child: Column(
